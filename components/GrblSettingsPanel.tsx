...
import { Settings, Save, RefreshCw, X, AlertTriangle, Maximize2, Minimize2, Calculator } from 'lucide-react';
...
const GrblSettingsPanel: React.FC<GrblSettingsPanelProps> = ({ settings, onClose, onRefresh, onOpenCalibration }) => {
    ...
    >
      <div className="p-4 border-b border-slate-700 flex justify-between items-center bg-slate-800">
        ...
        <div className="flex gap-2">
          {onOpenCalibration && (
            <button onClick={onOpenCalibration} className="p-1.5 text-slate-400 hover:text-sky-400 bg-slate-700 rounded" title="Steps Calibrator">
              <Calculator size={16} />
            </button>
          )}
